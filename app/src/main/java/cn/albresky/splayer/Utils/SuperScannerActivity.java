...
public class SuperScannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnStart = binding.tvStart;
        Button btnStop = binding.tvStop;
        mTVINfo = binding.tvInfo;
        ListView lvList = binding.lv;
        mETThread = binding.etThd;
        mETDepth = binding.etDepth;
        mCBDetail = binding.cbDetail;
        mCBHideDir = binding.cbHiddir;
        mCBNoMedia = binding.cbNomedia;
